...
class TestLink(TestCase):
    ...
    def test_eq(self):
        l = lambda: Link('a', example_url, rel=None)
        self.assertEqual(l(), l())
        self.assertNotEqual(l(), Link('img', example_url, rel=None))
        self.assertNotEqual(l(), Link('a', external_base_url, rel=None))
    ...
    def test_is_resource(self):
        ...
        l = Link('img', example_url, rel=None)
        self.assertTrue(l.is_resource())
    ...
    def test_is_internal(self):
        l = Link('a', example_url + '/sub_path', rel=None)
...
class TestPage(TestCase):
    def test(self):
        ...
        l1 = Link('a', s1, rel=None)
        s2 = external_base_url + '/another/doc.html'
        l2 = Link('a', s2, rel=None)
        s3 = 'relative/link.html'
        l3 = Link('a', s3, rel=None)
